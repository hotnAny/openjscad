...
//
function showAll(objects, spacing) {
    var showPieces = [];
    var dx = 0;
...
//
function trapezoidPrism(w1, w2, h, l) {
...
//
function makeText(text, strokeWidth, thickness, w, h) {
...
function makeRoundedPlatform(x, y, z, r) {
